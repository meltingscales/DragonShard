    ...
    return (
      <div className="min-h-screen bg-dragon-dark flex items-center justify-center">
        <div className="bg-red-600 text-white p-6 rounded-lg">
          <h2 className="text-xl font-bold mb-2">Error Loading Visualizations</h2>
          <p>{error}</p>
          <button 
            onClick={loadData}
    ...
    <div className="min-h-screen bg-dragon-dark text-white">
      ...
      <div className="bg-gradient-to-r from-dragon-primary to-dragon-secondary p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg opacity-90">Real-time monitoring and analysis tools</p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-dragon-card border border-dragon-border rounded-lg p-6">
            <h3 className="text-dragon-primary font-semibold mb-4">⚡ Attack Summary</h3>
            {attackSummary ? (
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-yellow-400">{attackSummary.completed_attacks}</div>
