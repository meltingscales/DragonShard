...
class JSCrawler:
    ...
    def __init__(self, max_depth: int = 2, max_pages: int = 50, 
                 wait_time: int = 2, headless: bool = True):
    ...
    def crawl(self, start_url: str) -> Set[str]:
        ...
        logger.info(f"Starting JS-enabled crawl from {start_url} (max_depth={self.max_depth}, max_pages={self.max_pages})")
