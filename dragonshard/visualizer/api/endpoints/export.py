...
from ..models import ExportRequest, ExportResponse, BaseResponse
        ...
        if export_request.filters:
            ...
            if "status" in export_request.filters:
                if isinstance(export_data, list):
                    export_data = [item for item in export_data if item.get("status") == export_request.filters["status"]]
